...
public class productcaricature extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backbtn.setOnClickListener(v -> {
            Intent intent = new Intent(productcaricature.this, Dashboardwdrawer.class);
    ...
    private void showBottomSheet(boolean isAddToCart) {
        int layoutRes = isAddToCart ? R.layout.popupaddtocartcaricature : R.layout.productpopupcaricature;
        ...
        if (isAddToCart) {
            ...
            popupAddToCartButton.setOnClickListener(v -> {
                ...
                Cartitem item = new Cartitem(
                        ...
                        qty,
                        "", // no material
                        R.drawable.caricature
                );

                CartManager.addToCart(item);
                Toast.makeText(productcaricature.this, "Added to cart", Toast.LENGTH_SHORT).show();
            ...
            popupBuyNowButton.setOnClickListener(v -> {
                ...
                Intent intent = new Intent(productcaricature.this, Cart.class);
                intent.putExtra("title", "Caricature");
                intent.putExtra("price", String.valueOf(unitPrice));
                intent.putExtra("totalPrice", String.valueOf(totalPrice));
                intent.putExtra("quantity", qty);
                intent.putExtra("material", ""); // no material
                intent.putExtra("imageResId", R.drawable.caricature);
                startActivity(intent);
