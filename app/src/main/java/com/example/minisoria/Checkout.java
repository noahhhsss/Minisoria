...
public class Checkout extends AppCompatActivity {
    ...
    private void handleIntent(Intent intent) {
        if (intent != null && intent.hasExtra("productName")) {
            ...
            Log.d("Checkout", "handleIntent called with productName=" + title + ", price=" + price + ", material=" + material + ", quantity=" + quantity + ", imageUri=" + imageUriString);
            ...
            Log.d("Checkout", "handleIntent: no productName extra found");
        }
}
